...
13.**无缝拼板：** 在原Layout完成的PCB文件上，设置其中一个角为原点，全选复制（Ctrl+C），之后鼠标变为十字，点击横向对应的坐标点，确定此点为下一个拼板的参考点（一般设置右下角为原点，左下角为参考点，向右横向拼板），对不规则的印刷板注意旋转颠倒来放置。特殊粘贴上选择：keep net name 和Duplicate Designator两个选项。拼板完成后，注意添加工艺边和Mark点（工艺边宽4mm，在keep-out层；Mark点为上下、左右均各两个，顶层和底层都需要）
